...
public class ImpApriori3 extends javax.swing.JFrame {
    
 public static ArrayList<ArrayList<Integer>> transactions=new ArrayList<ArrayList<Integer>>();//To store all the transactions
 public static ArrayList<ArrayList<Integer>> itemsTransactionList=new ArrayList<ArrayList<Integer>>();
 //To store the items and their corresponding transaction numbers
...
Vector colNames=new Vector();
	...
	while(r2.next())
	{
        ...
        stm2.close();
            ...
            //for(int i=1;i<10;i++)
             //   System.out.println("sot["+i+"]="+sot[i]);
         /*Iterator<ArrayList<Integer>> itr = itemsTransactionList.iterator();
         while(itr.hasNext()){
        ...
        try
	{
        ...
        {JOptionPane.showMessageDialog(null,"Exception after condiotin "+e);}                                
          return stop;                
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ImpApriori3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ImpApriori3().setVisible(true);
            }
        });
    }
